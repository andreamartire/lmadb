...
/**
 * Servlet implementation class EliminaUbicazione
 */
public class EliminaUbicazione extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			PreparedStatement st=conn.prepareStatement("DELETE FROM ubicazione WHERE codice=?");
			st.setString(1, codice);
			st.executeUpdate();
			conn.commit();
			conn.setAutoCommit(true);
			
			out.println("<center><font size=4>Eliminazione ubicazione effettuata con successo</font></center><br>" +
			"</body><center><a href=common/GestioneUbicazioni.jsp><button>Ok</button></a></center></html>");

		}catch(SQLException s){
			out.println("<center><font size=4>Errore eliminazione Ubicazione</font></center><br>" +
			"</body><center><a href=common/GestioneUbicazioni.jsp><button>Ok</button></a></center></html>");
